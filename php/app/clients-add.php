              ...
              <form id="addClientForm" onsubmit="handleAddClient(event)">
                ...
                <div class="tab">
                  <div class="form-group">
                    <label for="client_entry_date">Entry Date:*</label>
                    <input type="text" class="form-control field-required datetimepicker-input mt-n2" name="client_entry_date" id="client_entry_date" data-toggle="datetimepicker" data-target="#client_entry_date" placeholder="Entry Date" value="<?= date('Y-m-d') ?>" oninput="handleFormInput(event)" autocomplete="off">
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-4">
                      <label for="client_firstname">Firstname:*</label>
                      <input type="text" class="form-control field-required mt-n2" name="client_firstname" id="client_firstname" placeholder="Firstname" oninput="handleFormInput(event)" autocomplete="off">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="client_middlename">Middlename:</label>
                      <input type="text" class="form-control mt-n2" name="client_middlename" id="client_middlename" placeholder="Middlename" autocomplete="off">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="client_lastname">Lastname:*</label>
                      <input type="text" class="form-control field-required mt-n2" name="client_lastname" id="client_lastname" placeholder="Lastname" oninput="handleFormInput(event)" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="client_address">Address:*</label>
                    <textarea class="form-control field-required mt-n2" name="client_address" id="client_address" rows="3" placeholder="Address" oninput="handleFormInput(event)"></textarea>
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-6">
                      <label for="client_contact">Contact No:</label>
                      <input type="text" class="form-control mt-n2" name="client_contact" id="client_contact" placeholder="Contact No" autocomplete="off">
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="client_email">Email:</label>
                      <input type="text" class="form-control mt-n2" name="client_email" id="client_email" placeholder="Email" autocomplete="off">
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="client_birthday">Birthday:</label>
                      <input type="text" class="form-control datetimepicker-input mt-n2" name="client_birthday" id="client_birthday" data-toggle="datetimepicker" data-target="#client_birthday" placeholder="Birthday" autocomplete="off">
                    </div>
                    <div class="form-group col-sm-6">
                      <label for="marital_status">Marital Status:</label>
                      <select class="form-control field-required mt-n2" name="marital_status" id="marital_status" onchange="handleFormInput(event)">
                  ...
                  <div class="spouse-details ">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control mt-n2" name="spouse_name" id="spouse_name" placeholder="Name of Spouse" oninput="handleFormInput(event)" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="spouse_contact">Spouse Contact No:</label>
                      <input type="text" class="form-control mt-n2" name="spouse_contact" id="spouse_contact" placeholder="Spouse Contact No" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label for="spouse_email">Spouse Email:</label>
                      <input type="text" class="form-control mt-n2" name="spouse_email" id="spouse_email" placeholder="Spouse Email" autocomplete="off">
                    </div>
                  </div>
                </div>
                ...
                <div class="tab">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control mt-n2" name="company_name" id="company_name" placeholder="Company Name" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="company_address">Company Address:</label>
                    <input type="text" class="form-control mt-n2" name="company_address" id="company_address" placeholder="Company Address" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="company_contact">Company Contact No:</label>
                    <input type="text" class="form-control mt-n2" name="company_contact" id="company_contact" placeholder="Company Contact No" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="year_of_stay">Length of Service:</label>
                    <input type="text" class="form-control mt-n2" name="year_of_stay" id="year_of_stay" placeholder="Years of stay in the Company" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="position">Position in the Company:</label>
                    <input type="text" class="form-control mt-n2" name="position" id="position" placeholder="Position in the Company" autocomplete="off">
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-4">
                      <label for="tin_id">TIN ID.:</label>
                      <input type="text" class="form-control mt-n2" name="tin_id" id="tin_id" placeholder="TIN ID." autocomplete="off">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="sss_id">SSS ID.:</label>
                      <input type="text" class="form-control mt-n2" name="sss_id" id="sss_id" placeholder="SSS ID." autocomplete="off">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="monthly_salary">Monthly Salary:</label>
                      <input type="text" class="form-control mt-n2" name="monthly_salary" id="monthly_salary" placeholder="Monthly Salary" autocomplete="off">
                    </div>
                  </div>
                </div>
                ...
                <div class="tab">
                  <div class="row">
                    <div class="form-group mb-1 col-sm-6">
                      ...
                      <select class="form-control select2-project-name" name="project_name" id="project_name" data-placeholder="Project Name">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control mt-n2" name="remarks" id="remarks" rows="3" placeholder="Remarks"></textarea>
                  </div>
                </div>
