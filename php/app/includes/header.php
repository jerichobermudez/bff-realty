...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/tempusdominus-bootstrap-4.min.css?ver=<?= $version ?>">
  <link rel="stylesheet" href="/assets/css/daterangepicker.css?ver=<?= $version ?>">
  <link rel="stylesheet" href="/assets/css/select2.min.css?ver=<?= $version ?>">
  <link rel="stylesheet" href="/assets/css/select2-bootstrap4.min.css?ver=<?= $version ?>">
  <?php } ?>
